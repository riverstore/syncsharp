...
namespace SyncSharp.GUI
{
	public partial class TaskWizardForm : Form
	{
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Task name '" + txtName.Text.Trim() +
            ...
            if (CheckFolderPair())
            {
                try
                {
                    ...
                    SyncTask task = new SyncTask(txtName.Text, txtSource.Text,
                        txtTarget.Text, radSync.Checked, txtSource.Text.StartsWith(root), 
