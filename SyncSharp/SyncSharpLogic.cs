	...
	public class SyncSharpLogic : Observable
	{
		...
		public bool SaveProfile()
		{
			...
			try
			{
				...
				str = File.OpenWrite(_metaDataDir + @"\" + _currentProfile.ID);
				BinaryFormatter formatter = new BinaryFormatter();
			...
			catch (UnauthorizedAccessException)
			{
				...
				MessageBox.Show("Error in writing meta data files to " + currentDir +
						"\nPlease ensure you have permissions to write to " + currentDir, "SyncSharp",
						MessageBoxButtons.OK, MessageBoxIcon.Error);
				return false;
			}
			catch (Exception e)
			{
				MessageBox.Show(e.Message, "SyncSharp", MessageBoxButtons.OK, MessageBoxIcon.Error);
				return false;
			}
			finally
			{
		...
		public bool CheckProfileExists(string id)
		{
