...
namespace SyncSharp.GUI
{
	...
	public partial class FolderFilter : Form
	{
		...
		{
            if (Directory.Exists(currentTask.Source))
            {
            ...
            {
                srcTreeView.Nodes[0].Text = "Source folder does not exist";
                srcTreeView.ImageList = null;
            }

            if (Directory.Exists(currentTask.Target))
            {
            ...
            {
                tarTreeView.Nodes[0].Text = "Target does not exist";
                tarTreeView.ImageList = null;
            }
